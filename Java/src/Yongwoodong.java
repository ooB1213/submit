...
public class Yongwoodong extends JPanel {
	JComboBox combo = null;
	
	private final Object [] colNames = {"ChkBox","¸Þ´º","¼ö·®","°¡°Ý", "¾ÆÀÌÄÜ"};
	private Object [][] datas = {{false,"³ª°¡»ç³¢Â«»Í","","4500",null},
								{false,"»çÃµººÀ½¹ä","","5000", null},
								{false,"¿ìµ¿¾Ë¹ä¼¼Æ®","","10000",null},
								{false,"³Ã¸ð¹Ð","","5000",null}};
	...
	public Yongwoodong() {
		...
		table.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 17));
		add(table);
		...
		lblNewLabel.setBounds(30, 20, 439, 15);
		add(lblNewLabel);
		...
		calling.setBackground(new Color(240, 248, 255));
	...
	class MyCheckCellRender extends DefaultTableCellRenderer{
	 ...
	 class MyIconRenderer extends DefaultTableCellRenderer{
		 ...
		 ImageIcon icon[] ={ new ImageIcon(getClass().getResource("/images/jjanbbong.jpg")),
				  new ImageIcon(getClass().getResource("/images/bokumbab.jpg")),
				  new ImageIcon(getClass().getResource("/images/albab.jpg")),
				new ImageIcon(getClass().getResource("/images/momil.jpg"))
		  };
